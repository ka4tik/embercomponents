...
App.Router.map(function() {
    ...
    this.route("datatable", { path:"/datatable" });
...
App.DatatableRoute = Ember.Route.extend({
    model:function(){
        return App.DataArray;
    }
});

App.DatatableController=Ember.ArrayController.extend(Ember.DataTableMixin,{
...
App.AutocompleteController=Ember.Controller.extend({
    data:function(){
        return Ember.A([{text:'Argentina'},{text:'Korea'},{text:'India'},{text:'Russia'},{text:'Germany'},{text:'Thiland'},{text:'China'},{text:'Italy'},{text:'Spain'},{text:'Portugal'}]);
    }.property()
});
